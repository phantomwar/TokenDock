...
class _Response { _Response(this.statusCode, this.body); final int statusCode; final String body; }
class _Http implements AntigravityOAuthHttpRunner {
  _Http(this.responses); final List<_Response> responses;
  @override
  Future<AntigravityOAuthHttpResponse> post(Uri uri, {required Map<String, String> headers, required String body}) async { final result = responses.removeAt(0); return AntigravityOAuthHttpResponse(statusCode: result.statusCode, body: result.body); }
}
