...
- `flutter test --no-pub`: **430/430 passed** (`d8232b6`), re-confirmed on three consecutive runs. The 366-test gate was met on three consecutive runs at `9ae626f`; 379, 386, 389, 399, 409, 410 and 417 were each re-confirmed on three consecutive runs before the next change. Baseline before the 2026-09-26 session was 235.
